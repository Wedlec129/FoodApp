...
class JSONLoadModelCategory: ObservableObject {
    @Published var responseData: modelCategory?
    ...
    func fetchData() {
        ...
        URLSession.shared.dataTask(with: url) { data, response, error in
            ...
            do {
                ...
                let responseData = try decoder.decode(modelCategory.self, from: data)
